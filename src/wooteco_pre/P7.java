...
public class P7 {
    public static void main(String[] args) {
        ...
        Map<String, Integer> map = getStringIntegerMap(user, friends, userFriends);
        ...
        List<String> sortedList = sort(map);
    ...
    private static Map<String, Integer> getStringIntegerMap(String user, List<List<String>> friends, List<String> userFriends) {
